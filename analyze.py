...
parser.add_argument('--slist', type=str, default='inputs/insects459_sp.csv', help='Path to the species list.')
parser.add_argument('--flist', type=str, default='inputs/c-n-europe_insects.csv', help='Path to the filter list of species.')
parser.add_argument('--i', type=str, default='audio/20250807_214817.WAV', help='Input audio sample.')
parser.add_argument('--o', type=str, default='tmp/avesecho', help='Output directory for temporary audio chunks.')
parser.add_argument('--mconf', type=float, default=0.05, help='Minimum confidence threshold for predictions.')
...
parser.add_argument('--model_name', type=str, default='passt', help='Name of the model to use.')
...
if __name__ == "__main__":
    ...
    classifier = AvesEcho(model_name=args.model_name, slist=args.slist, flist=args.flist,
                    ...
                    outputd = args.o, avesecho_mapping='inputs/mapping.csv',
                    maxpool=args.maxpool, add_csv=args.add_csv, args=args)
    
    classifier.analyze_audio(args.i, lat=args.lat, lon=args.lon)
